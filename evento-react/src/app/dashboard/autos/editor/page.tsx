...
export default function App() {
	...
	const fetchCompanies = async () => {
		try {
			const response = await axiosInstanceAuth.get("/api/autos/editor");
	...
	const renderCell = React.useCallback((auto: any, columnKey: any) => {
		...
		switch (columnKey) {
			...
			case "type":
				if (auto.type === "truck") { // <--- CORRECTED COMPARISON
	...
	return (
		<div>
			<h1 className="text-3xl mb-5">Автомобили редактора компаний</h1>
